...
- Learning Event-Driven Microservices Architecture with `SpringBoot` and `Apache Kafka`(**repository**: [searchEngineTFIDF](https://github.com/omgshalihin/searchEngineTFIDF))
